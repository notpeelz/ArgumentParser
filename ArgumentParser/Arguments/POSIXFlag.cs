...
namespace ArgumentParser.Arguments
{
    ...
    public class POSIXFlag : POSIXShortArgument, IFlag
    {
        ...
        public POSIXFlag(Char tag, FlagOptions options = FlagOptions.None, String defaultValue = null)
        ...
        /// <param name="options">The value conversion behavior.</param>
        /// <param name="defaultValue">The default value of the argument.</param>
        public POSIXFlag(Char tag, String description, FlagOptions options = FlagOptions.None, String defaultValue = null)
