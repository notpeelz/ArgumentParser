...
namespace ArgumentParser.Arguments
{
    ...
    public class POSIXFlag<T> : POSIXShortArgument<T>, IFlag
    {
        ...
        public POSIXFlag(Char tag, FlagOptions options = FlagOptions.None, TypeConverter typeConverter = null, T defaultValue = default (T))
        ...
        /// <param name="typeConverter">The type converter to use for value conversion.</param>
        /// <param name="defaultValue">The default value of the argument.</param>
        public POSIXFlag(Char tag, String description, FlagOptions options = FlagOptions.None, TypeConverter typeConverter = null, T defaultValue = default (T))
