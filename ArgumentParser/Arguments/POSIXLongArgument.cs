...
namespace ArgumentParser.Arguments
{
    ...
    public class POSIXLongArgument : Argument
    {
        ...
        public POSIXLongArgument(String tag, String defaultValue = null, Boolean allowComposite = false)
        ...
        /// <param name="defaultValue">The default value of the argument.</param>
        /// <param name="allowComposite">A boolean value indicating whether trailing values should be interpreted.</param>
        public POSIXLongArgument(String tag, String description, String defaultValue = null, Boolean allowComposite = false)
