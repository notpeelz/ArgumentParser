...
namespace ArgumentParser.Arguments
{
    ...
    public class POSIXLongFlag : POSIXLongArgument, IFlag
    {
        ...
        public POSIXLongFlag(String tag, FlagOptions options = FlagOptions.None, String defaultValue = null, Boolean allowComposite = false)
        ...
        /// <param name="defaultValue">The default value of the argument.</param>
        /// <param name="allowComposite">A boolean value indicating whether trailing values should be interpreted.</param>
        public POSIXLongFlag(String tag, String description, FlagOptions options = FlagOptions.None, String defaultValue = null, Boolean allowComposite = false)
