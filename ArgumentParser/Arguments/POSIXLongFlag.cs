...
namespace ArgumentParser.Arguments
{
    ...
    public class POSIXLongFlag : POSIXLongArgument, IFlag
    {
        ...
        public POSIXLongFlag(String tag, FlagOptions options = FlagOptions.None, String defaultValue = null)
        ...
        /// <param name="options">The value conversion behavior.</param>
        /// <param name="defaultValue">The default value of the argument.</param>
        public POSIXLongFlag(String tag, String description, FlagOptions options = FlagOptions.None, String defaultValue = null)
