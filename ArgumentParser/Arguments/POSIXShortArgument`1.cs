...
namespace ArgumentParser.Arguments
{
    ...
    public class POSIXShortArgument<T> : ShortArgument<T>
    {
        ...
        public POSIXShortArgument(Char tag, TypeConverter typeConverter = null, T defaultValue = default (T))
        ...
        /// <param name="typeConverter">The type converter to use for value conversion.</param>
        /// <param name="defaultValue">The default value of the argument.</param>
        public POSIXShortArgument(Char tag, String description, TypeConverter typeConverter = null, T defaultValue = default (T))
            : base(Prefix, tag, description, typeConverter, defaultValue) { }
