...
namespace ArgumentParser.Arguments
{
    ...
    public class POSIXShortArgument<T> : ShortArgument<T>
    {
        ...
        public POSIXShortArgument(Char tag, TypeConverter typeConverter = null, T defaultValue = default (T), Boolean allowComposite = false)
        ...
        /// <param name="defaultValue">The default value of the argument.</param>
        /// <param name="allowComposite">A boolean value indicating whether trailing values should be interpreted.</param>
        public POSIXShortArgument(Char tag, String description, TypeConverter typeConverter = null, T defaultValue = default (T), Boolean allowComposite = false)
