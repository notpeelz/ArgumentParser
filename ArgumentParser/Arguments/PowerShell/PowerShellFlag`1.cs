...
namespace ArgumentParser.Arguments.PowerShell
{
    ...
    public class PowerShellFlag<T> : FlagArgument<T>
    {
        ...
        public PowerShellFlag(String tag, String description = null, ValueOptions valueOptions = ValueOptions.Single, FlagOptions flagOptions = FlagOptions.None, TypeConverter typeConverter = null, PreprocessorDelegate preprocessor = null, T defaultValue = default (T))
