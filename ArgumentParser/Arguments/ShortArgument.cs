//-----------------------------------------------------------------------
// <copyright file="ShortArgument.cs" company="LouisTakePILLz">
...
{
    /// <summary>
    /// Represents a short argument (argument with a single-character tag) of an undefined value type.
    /// </summary>
    public abstract class ShortArgument : IArgument<String>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:ArgumentParser.Arguments.ShortArgument"/> class.
        /// </summary>
