...
namespace ArgumentParser.Arguments.Windows
{
    ...
    public class WindowsArgument<T> : Argument<T>
    {
        ...
        public WindowsArgument(String tag, String description = null, ValueOptions valueOptions = ValueOptions.Single, TypeConverter typeConverter = null, PreprocessorDelegate preprocessor = null, T defaultValue = default (T))
