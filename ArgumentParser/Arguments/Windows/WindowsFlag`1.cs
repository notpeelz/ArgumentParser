...
namespace ArgumentParser.Arguments.Windows
{
    ...
    public class WindowsFlag<T> : FlagArgument<T>
    {
        ...
        public WindowsFlag(String tag, String description = null, ValueOptions valueOptions = ValueOptions.Single, FlagOptions flagOptions = FlagOptions.None, TypeConverter typeConverter = null, Parser.PreprocessorDelegate preprocessor = null, T defaultValue = default (T))
