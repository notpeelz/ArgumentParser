...
namespace ArgumentParserTest
{
    ...
    {
        private static readonly IArgument<String[]> pushShortArgument = new POSIXShortArgument<String[]>('p', String.Empty, new StringArrayConverter('\x20', StringSplitOptions.RemoveEmptyEntries));
